...
/**
 * Generated class for the ImprimerBonRetourPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-imprimer-bon-retour',
  templateUrl: 'imprimer-bon-retour.html',
})
export class ImprimerBonRetourPage {
  //dataDevis: any;
  liste: any=[];
