...
@Injectable()
export class BonRetourProvider {
databonSortie
  ...
  get(){
    return new Promise((resolve, reject) => {
     this.storage.get('token').then((value) => {
       ...
       this.http.get('http://testmariadb.alwaysdata.net/public/bonretour/bonretours', {headers: headers})
         .map(res => res.json())
         .subscribe(data => {
           resolve(data);
         }, (err) => {
 ...
 loadBonsortie() {
     ...
     return new Promise(resolve => {
       ...
       this.http.get('http://testmariadb.alwaysdata.net/public/bonretour/bonretours')
         .map(res => res.json())
         .subscribe(data => {
...
save(data) {
  return new Promise((resolve, reject) => {
    this.http.post('http://testmariadb.alwaysdata.net/public/bonretour/bonretours',data)
      .subscribe(res => {
        resolve(res);
      }, (err) => {
        reject(err);
